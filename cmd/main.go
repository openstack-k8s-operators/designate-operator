...
// Package main is the entry point for the designate-operator.
package main
...
import (
	...
	"github.com/openstack-k8s-operators/designate-operator/internal/controller"
	webhookv1beta1 "github.com/openstack-k8s-operators/designate-operator/internal/webhook/v1beta1"

	// +kubebuilder:scaffold:imports

	networkv1 "github.com/k8snetworkplumbingwg/network-attachment-definition-client/pkg/apis/k8s.cni.cncf.io/v1"
	oshiftapi "github.com/openshift/api/operator/v1"
...
func init() {
	...
	utilruntime.Must(oshiftapi.AddToScheme(scheme))
...
func main() {
	...
	if err := (&controller.DesignateBackendbind9Reconciler{
		Client:  mgr.GetClient(),
		Scheme:  mgr.GetScheme(),
		Kclient: kclient,
	}).SetupWithManager(context.Background(), mgr); err != nil {
	...
	if err := (&controller.UnboundReconciler{
		Client:  mgr.GetClient(),
		Scheme:  mgr.GetScheme(),
		Kclient: kclient,
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err := webhookv1beta1.SetupDesignateWebhookWithManager(mgr); err != nil {
