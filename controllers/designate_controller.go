...
func (r *DesignateReconciler) Reconcile(ctx context.Context, req ctrl.Request) (result ctrl.Result, _err error) {
	...
	cl := condition.CreateList(
		...
		condition.UnknownCondition(designatev1beta1.RabbitMqTransportURLReadyCondition, condition.InitReason, designatev1beta1.RabbitMqTransportURLReadyInitMessage),
...
func (r *DesignateReconciler) reconcileNormal(ctx context.Context, instance *designatev1beta1.Designate, helper *helper.Helper) (ctrl.Result, error) {
	...
	if err != nil {
		instance.Status.Conditions.Set(condition.FalseCondition(
			designatev1beta1.RabbitMqTransportURLReadyCondition,
			condition.ErrorReason,
			condition.SeverityWarning,
			designatev1beta1.RabbitMqTransportURLReadyErrorMessage,
			err.Error()))
		return ctrl.Result{}, err
	}
	...
	instance.Status.Conditions.MarkTrue(
		designatev1beta1.RabbitMqTransportURLReadyCondition,
		designatev1beta1.RabbitMqTransportURLReadyMessage)
