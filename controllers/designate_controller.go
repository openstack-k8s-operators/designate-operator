...
func (r *DesignateReconciler) generateServiceConfigMaps(
	...
	cms := []util.Template{
		// ScriptsConfigMap
		{
			Name:         designate.ScriptsVolumeName(designate.ServiceName),
			Namespace:    instance.Namespace,
		...
		{
			Name:          designate.ConfigVolumeName(designate.ServiceName),
			Namespace:     instance.Namespace,
		...
		{
			Name:         designate.DefaultsVolumeName(designate.ServiceName),
			Namespace:    instance.Namespace,
