...
// GetLogger -
func (r *DesignateProducerReconciler) GetLogger() logr.Logger {
	return r.Log
}
...
func (r *DesignateProducerReconciler) Reconcile(ctx context.Context, req ctrl.Request) (result ctrl.Result, _err error) {
	_ = r.Log.WithValues("designateproducer", req.NamespacedName)
...
func (r *DesignateProducerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	svcSecretFn := func(o client.Object) []reconcile.Request {
		...
		if err := r.Client.List(context.Background(), apis, listOpts...); err != nil {
			r.Log.Error(err, "Unable to retrieve Producer CRs %v")
			return nil
		}
...
func (r *DesignateProducerReconciler) reconcileNormal(ctx context.Context, instance *designatev1beta1.DesignateProducer, helper *helper.Helper) (ctrl.Result, error) {
	...
	deplDef := designateproducer.Deployment(instance, inputHash, serviceLabels, serviceAnnotations)
