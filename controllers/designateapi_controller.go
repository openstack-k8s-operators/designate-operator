...
func (r *DesignateAPIReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager) error {
	...
	// index topologyField
	if err := mgr.GetFieldIndexer().IndexField(context.Background(), &designatev1beta1.DesignateAPI{}, topologyField, func(rawObj client.Object) []string {
...
func (r *DesignateAPIReconciler) generateServiceConfigMaps(
	...
	cms := []util.Template{
		// Custom ConfigMap
		{
			Name:          designate.ConfigVolumeName(designateapi.Component),
			Namespace:     instance.Namespace,
		...
		{
			Name:         designate.DefaultsVolumeName(designateapi.Component),
			Namespace:    instance.Namespace,
