...
// Bind IP ConfigMap management for the Designate CR.
// This file manages the lifecycle of the designate-bind-ip-map ConfigMap(s),
// which are owned by the Designate CR (not DesignateBackendbind9), in both
// single-pool and multipool modes.
