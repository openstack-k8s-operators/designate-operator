...
import (
	...
	designateapi "github.com/openstack-k8s-operators/designate-operator/internal/designateapi"
...
func (r *DesignateAPIReconciler) reconcileNormal(ctx context.Context, instance *designatev1beta1.DesignateAPI, helper *helper.Helper) (ctrl.Result, error) {
	...
	if err := object.PruneSecretConsumerFinalizers(
		ctx, helper, instance.Namespace, designate.ACConsumerFinalizer,
		instance.Status.ApplicationCredentialSecret,
		instance.Spec.Auth.ApplicationCredentialSecret,
	); err != nil {
		return ctrl.Result{}, err
