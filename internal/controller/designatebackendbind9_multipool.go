...
// This file contains logic for managing resources owned by DesignateBackendbind9
// (Services, StatefulSets) in multipool mode, including migration between
// single-pool and multipool modes. Bind IP ConfigMap management (owned by the
// Designate CR) lives in designate_bind_configmaps.go. TSIG secret management
// lives in designatebackendbind9_tsig.go.
