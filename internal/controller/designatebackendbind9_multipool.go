...
// (Services, StatefulSets, TSIG secrets) in multipool mode, including migration
// between single-pool and multipool modes. Bind IP ConfigMap management (owned by
// the Designate CR) lives in designate_bind_configmaps.go.
