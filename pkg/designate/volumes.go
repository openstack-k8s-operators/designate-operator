...
func GetStandardVolumeMapping(name string) []VolumeMapping {
	return []VolumeMapping{
		...
		{Name: DefaultsVolumeName(ServiceName), Type: SecretMount, MountPath: "/var/lib/config-data/common-overwrites"},
		{Name: ConfigVolumeName(name), Type: SecretMount, MountPath: "/var/lib/config-data/service"},
		{Name: MergedVolumeName(name), Type: MergeMount, MountPath: "/var/lib/config-data/merged"},
		{Name: DefaultsVolumeName(name), Type: SecretMount, MountPath: "/var/lib/config-data/overwrites"},
		{Name: MergedDefaultsVolumeName(name), Type: MergeMount, MountPath: "/var/lib/config-data/config-overwrites"},
	}
}
