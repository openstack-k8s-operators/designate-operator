...
// Desigante Reasons used by API objects.
const ()
...
const (
	...
	DesiganteCentralReadyErrorMessage = "DesignateCentral error occured %s"
	...
	DesiganteSinkReadyErrorMessage = "DesignateSink error occured %s"
	...
	DesiganteWorkerReadyErrorMessage = "DesignateWorker error occured %s"
	...
	DesiganteMdnsReadyErrorMessage = "DesignateMdns error occured %s"
	...
	DesiganteProducerReadyErrorMessage = "DesignateProducer error occured %s"
