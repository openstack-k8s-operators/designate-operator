...
func (instance *DesignateWorker) GetSpecTopologyRef() *topologyv1.TopoRef {
...
func (instance *DesignateWorker) SetLastAppliedTopology(topologyRef *topologyv1.TopoRef) {
