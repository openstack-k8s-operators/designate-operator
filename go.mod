...
require (
	...
	github.com/openstack-k8s-operators/designate-operator/api v0.0.0-20230722140248-51cd77becf31
...
replace github.com/openshift/api => github.com/openshift/api v0.0.0-20230724190601-61a5301895a5 //allow-merging
