ARG GOLANG_BUILDER=docker.io/golang:1.19
...
ARG IMAGE_COMPONENT="designate-operator-container"
ARG IMAGE_NAME="designate-operator"
ARG IMAGE_VERSION="1.0.0"
ARG IMAGE_SUMMARY="Designate Operator"
ARG IMAGE_DESC="This image includes the designate-operator"
